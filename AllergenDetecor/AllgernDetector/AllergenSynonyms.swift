...
{
    static let allAllergensSynonyms = milkSynonyms + peanutSynonyms + treeNutSynonyms + eggSynonyms
                                      + sesameSynonyms + fishSynonyms + crustacea​Synonyms + soySynonyms
                                      + lupinSynonyms + wheatSynonyms
    ...
    static let treeNutSynonyms = [String](arrayLiteral: "Tree nuts","Almonds", "Almond meal","Almond paste","Artificial nuts","Beer nuts",
    ...
    static let fishSynonyms = [String](arrayLiteral: "Fish", "Anchovy","Barramundi","Bass","Bluefish","Bream","Carp","Catfish","Caviar",
    ...
    static let crustacea​Synonyms = [String](arrayLiteral:"Crustacea", "Shellfish", "Balmain bugs", "Crab","Crayfish", "Lobster",
